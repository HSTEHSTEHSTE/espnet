...
from espnet2.train.cont_learn import CL

# temporary imports, to remove during refactor
import os
...
class Trainer:
    ...
    def run(
        ...
        cl_type: str,
        cl_iter_factory: Optional[AbsIterFactory],
        ...
        for iepoch in range(start_epoch, trainer_options.max_epoch + 1):
            ...
            cl_object = None
            if cl_iter_factory is not None:
                previous_dataset_list = cl_iter_factory.build_iter(0)
                cl_object = CL(model = model, dataset = previous_dataset_list, batch_size = 32, num_gpu = trainer_options.ngpu, type = cl_type)

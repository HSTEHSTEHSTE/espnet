...
./asr.sh \
    --asr_stats_dir "exp_assamese_cantonese_ewc/asr_stats_raw_car" \
    --cl_asr_stats_dir "exp_assamese_cantonese_ewc/cl_asr_stats_raw_car" \
    --expdir "exp_assamese_cantonese_ewc" \

...
./asr.sh \
    --asr_stats_dir "exp_assamese_cantonese_lwf/asr_stats_raw_car" \
    --cl_asr_stats_dir "exp_assamese_cantonese_lwf/cl_asr_stats_raw_car" \
    --expdir "exp_assamese_cantonese_lwf" \

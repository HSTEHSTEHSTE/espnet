...
train_set=train_assamese_bengali
valid_set=dev_assamese_bengali
...
./asr.sh \
    --asr_stats_dir "exp_assamese_bengali_combined/asr_stats_raw_car" \
    --cl_asr_stats_dir "exp_assamese_bengali_combined/cl_asr_stats_raw_car" \
    --expdir "exp_assamese_bengali_combined" \
    --dumpdir "dump_assamese_bengali_combined" \
    --stage 12 \
    --stop_stage 13 \
    --lang assamese_bengali_combined \
